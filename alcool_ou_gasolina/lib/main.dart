...
class _HomeState extends State<Home> {
  ...
  void _calculaCombustivelIdeal() {
    ...
    //se a propor��o � menor do 0.7, ent�o vale mais a pena abastecer com alcool
    //caso contr�rio, vale mais a pena abastecer com gasosa...

    // if(proporcao < 0.7) {
    //   _resultado = "Abaste�a com �lcool";
    // } else {
    //   _resultado = "Abaste�a com Gasolina";
    // }
    //� a mesma coisa que:
